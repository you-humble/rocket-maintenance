		...
		case '/': // Prefix: "/api/v1/orders"
			...
			if len(elem) == 0 {
				...
				case "POST":
					...
					r.summary = "Create a new spacecraft build order"
			...
			case '/': // Prefix: "/"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "Get spacecraft build order by UUID"
					...
					case 'c': // Prefix: "cancel"
						...
						if len(elem) == 0 {
							...
							case "POST":
								...
								r.summary = "Cancel an existing spacecraft build order"
					...
					case 'p': // Prefix: "pay"
						...
						if len(elem) == 0 {
							...
							case "POST":
								...
								r.summary = "Pay for an existing spacecraft build order"
